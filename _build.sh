...
./release-tools/mkbootimg --cmdline "androidboot.hardware=qcom user_debug=31 zcache" --kernel $BIN_DIR/kernel --base 0x80200000 --pagesize 2048 --ramdisk_offset 0x01400000 --ramdisk $BIN_DIR/ramdisk-$IMAGE_NAME.img --output $BIN_DIR/$IMAGE_NAME.img
