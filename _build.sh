...
./release-tools/mkbootimg --cmdline "androidboot.hardware=qcom user_debug=31 zcache" --kernel $BIN_DIR/kernel  --ramdisk $BIN_DIR/ramdisk-$IMAGE_NAME.img --base 0x80200000 --pagesize 2048 --ramdiskaddr 0x81500000 --output $BIN_DIR/$IMAGE_NAME.img
